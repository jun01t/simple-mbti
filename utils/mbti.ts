...
export const typeInfo: Record<string, MbtiTypeInfo> = {
  ...
  INTP: {
    ...
    careers: ['ソフトウェア開発', '大学教員', 'アナリスト', '発明家']
  },
  ENTJ: {
    code: 'ENTJ',
    name: '指揮官',
    ...
    careers: ['経営者', 'プロジェクトマネージャー', '弁護士', '投資家']
  },
  ENTP: {
    code: 'ENTP',
    name: '討論者',
    ...
    careers: ['起業家', 'マーケター', '商品企画', 'ジャーナリスト']
  },
  INFJ: {
    code: 'INFJ',
    name: '提唱者',
  ...
  ENFP: {
    ...
    careers: ['イベントプランナー', 'クリエイティブ職', '営業企画', 'タレントマネージャー']
  },
  ISTJ: {
    code: 'ISTJ',
    name: '管理者',
  ...
  ISFJ: {
    ...
    traits: ['思いやり', '献身的', '丁寧'],
    careers: ['看護師', '図書館司書', 'カスタマーサポート', '保育士']
  },
  ESTJ: {
    code: 'ESTJ',
    name: '幹部',
  ...
  ESFJ: {
    ...
    traits: ['親切', '協力的', '気配り'],
    careers: ['医療事務', 'ホテルスタッフ', '営業', 'イベント運営']
  },
  ISTP: {
    code: 'ISTP',
    name: '巨匠',
  ...
  ESFP: {
    ...
    careers: ['演出・芸能', 'ツアーガイド', '販売スタッフ', 'イベントMC']
  }
}
